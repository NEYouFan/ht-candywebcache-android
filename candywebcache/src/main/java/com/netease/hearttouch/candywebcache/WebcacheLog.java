 ...
 */
public class WebcacheLog {
    public static String TAG = "Webcache";
    ...
    private static String buildMessage(String format, Object... args) {
        ...
        if (false) {
            ...
            // Walk up the stack looking for the first caller outside of WebcacheLog.
            // It will be at least two frames up, so start there.
            for (int i = 2; i < trace.length; i++) {
                Class<?> clazz = trace[i].getClass();
                if (!clazz.equals(WebcacheLog.class)) {
    ...
    static class MarkerLog {
        public static final boolean ENABLED = WebcacheLog.DEBUG;
